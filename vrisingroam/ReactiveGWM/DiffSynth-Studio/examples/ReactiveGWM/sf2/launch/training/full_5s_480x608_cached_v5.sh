#!/bin/bash
# Mode A + cache: Full DiT fine-tune (cached) — v5 dataset, resume from run_v4 step-24000.
# 7 GPU (1-7), bs=1/GPU, accum=1 -> eff bs=7. GPU 0 left free.
set -e
...
OUT="${OUT:-/home/zeqingwang/zeqingwang/models/train/sf2/Baseline/full_5s_480x608/run_v5/p3}"

RESUME_CKPT="${RESUME_CKPT:-/home/zeqingwang/zeqingwang/models/train/sf2/Baseline/full_5s_480x608/run_v5/step-6000.safetensors}"
...
echo "=== SF2_final / Mode A+cache: Full DiT fine-tune (cached) — run_v5 ==="
echo "Data:    ${DATA_ROOT}"
echo "CSV:     ${METADATA}"
...
PYTHONUNBUFFERED=1 accelerate launch --num_processes=7 --multi_gpu --main_process_port 29606 \
