#!/bin/bash
# Mode A + cache: Full DiT fine-tune (cached) — v5 dataset, p4 resume from p3/step-3000.
# 8 GPU (0-7), bs=1/GPU, accum=1 -> eff bs=8.
set -e
...
OUT="${OUT:-/home/zeqingwang/zeqingwang/models/train/sf2/Baseline/full_5s_480x608/run_v5/p4}"

RESUME_CKPT="${RESUME_CKPT:-/home/zeqingwang/zeqingwang/models/train/sf2/Baseline/full_5s_480x608/run_v5/p3/step-3000.safetensors}"
...
echo "=== SF2_final / Mode A+cache: Full DiT fine-tune (cached) — run_v5/p4 ==="
echo "Data:    ${DATA_ROOT}"
echo "CSV:     ${METADATA}"
...
PYTHONUNBUFFERED=1 accelerate launch --num_processes=8 --multi_gpu --main_process_port 29606 \
