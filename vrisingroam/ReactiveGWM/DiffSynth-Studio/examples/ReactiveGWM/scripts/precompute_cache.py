...
Hash protocol MUST stay byte-identical with model_training/cached_dataset.py.

Usage (single GPU, full CSV):
  python examples/ReactiveGWM/scripts/precompute_cache.py \
    --game sf2 \
    --metadata <csv> --dataset_base <root> --cache_root <out> \
...
def main():
    ...
    p.add_argument("--metadata", required=True, help="metadata.csv path")
