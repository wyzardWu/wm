...
# Ensure examples/ReactiveGWM/data importable
_HERE = Path(__file__).resolve().parent.parent  # examples/ReactiveGWM_casual_forcing/
_REACTIVE_GWM_DATA = _HERE.parent / "ReactiveGWM"
if str(_REACTIVE_GWM_DATA) not in sys.path:
    sys.path.insert(0, str(_REACTIVE_GWM_DATA))
