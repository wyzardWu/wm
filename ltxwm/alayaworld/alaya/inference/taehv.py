# Vendored from https://github.com/madebyollin/taehv (MIT license; see taehv repo LICENSE).
# Source: github.com/madebyollin/taehv (taeltx2_3_wide variant)
# (patch_size=4, latent_channels=128, 8x temporal upscale) matching LTX-2.3 latents.
#!/usr/bin/env python3
"""
