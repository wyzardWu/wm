...
class LtxvTrainer:
    ...
    def _save_checkpoint(self) -> Path | None:
        ...
        if saved_weights_path in self._checkpoint_paths:
            # Final save reuses the last interval step's path; a duplicate entry
            # would make _cleanup_checkpoints unlink the file it just saved.
            self._checkpoint_paths.remove(saved_weights_path)
