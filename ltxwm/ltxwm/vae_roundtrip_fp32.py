...
OUT = "/data/yuzhewu/vrisingroam/ltx_probes/vae_roundtrip_fp32.mp4"
...
vd = VideoDecoder(CKPT, dtype=torch.float32, device=dev)
...
with torch.inference_mode():
    ...
    chunks = vd(lat.float(), tc, generator=gen, dtype=torch.float32)
